...
Widget build(BuildContext context) {
			...
			body: Padding(
				...
				child: u == null
						...
						: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
								Row(children: [
									CircleAvatar(radius: 44, backgroundColor: Colors.deepPurple.shade50, child: Text(u.name.isNotEmpty ? u.name[0].toUpperCase() : 'U', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w600))),
	...
	Widget _statItem(String title, String value) => Column(children: [Text(value, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)), const SizedBox(height: 4), Text(title, style: const TextStyle(color: Colors.grey))]);
